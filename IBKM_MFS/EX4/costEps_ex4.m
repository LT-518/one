function ceps =costEps_ex4(ep,center,coll,bdpt_s,psr,noise,nb,lambda,exact,exact_nu,exact_L,fuds_1,fuds_2,fuds_3,...
    fuds_1laplace,fuds_2laplace,fuds_3laplace,dfuds_1,dfuds_2,dfuds_3,Nor)
xi=2;
source1=ep*bdpt_s'+center;
source2=xi*ep*bdpt_s'+center;
...
L_BKM(isnan(L_BKM))=0;
%%
DMx2=coll(:,1)-repmat(source(:,1)',nb,1); 
